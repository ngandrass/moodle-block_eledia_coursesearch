...
$string['courselistingstyle'] = 'Course listing style';
$string['courselistingstyle_boostunion'] = 'Boost Union';
$string['courselistingstyle_default'] = 'Default';
$string['courselistingstyle_desc'] = 'Choose how course cards and lists are rendered. The "Boost Union" option is only available when Boost Union is the active theme.';
...
$string['selectedoption_bottom'] = 'Below actions buttons';
$string['selectedoption_inline'] = 'Inline within filter input fields';
$string['selectedoption_off'] = 'Off';
$string['selectedoption_top'] = 'Between search fields and action buttons';
